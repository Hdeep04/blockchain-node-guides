...
You are about to exit the validator with public key:
0xb6b94fc...
This is irreversible. Please type 'Exit my validator' to confirm:
→ Exit my validator
```
